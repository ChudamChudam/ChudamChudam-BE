...
public class AwsS3Service {
    ...
    public AwsS3FileResponseDto uploadFile(MultipartFile multipartFile){
        if(multipartFile==null|| multipartFile.isEmpty()){
            throw new IllegalArgumentException("MultipartFile cannot be null or empty");
        }

        // return new AwsS3FileResponse(uploadToS3ReturnURL(multipartFile));
        AwsS3FileResponseDto response = new AwsS3FileResponseDto(uploadToS3ReturnURL(multipartFile));
        return response;
    }
