...
import com.teosprint.chudam.config.s3.AwsS3FileResponse;
import com.teosprint.chudam.config.s3.AwsS3Service;
    ...
    public CreateLetterResponseDto createLetter(CreateLetterRequestDto createLetterRequest) {
        try{
            ...
            if(multipartFile != null){
                AwsS3FileResponse response = awsS3Service.uploadFile(multipartFile);
